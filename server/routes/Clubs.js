...
router.get('/', function (request, response) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, ClubManager_1.ClubManager.GetClubs()];
            case 1:
                result = _a.sent();
...
router.get('/:clubId', function (request, response) { return __awaiter(_this, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, ClubManager_1.ClubManager.GetClubById(request.params.clubId)];
            case 1:
                result = _a.sent();
                response.send(result);
                return [2];
