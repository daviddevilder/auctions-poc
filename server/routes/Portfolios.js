...
var PortfolioManager_1 = require("../modules/PortfolioManager");
...
router.get('/', function (request, response) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, PortfolioManager_1.PortfolioManager.GetPortfolios()];
            case 1:
                result = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4, PortfolioManager_1.PortfolioManager.CreatePortfolio(name, holdings)];
            case 1:
                _a.sent();
                response.send();
                return [2];
