                        ...
                        Auction_1.AuctionModel.find({}, function (err, auctions) {
                            try {
                                ...
                                auctions.forEach(function (auction) {
                                    results.push(new Auction_2.Auction(auction.clubId, auction.title, auction.imageUri, auction.providedBy, auction.reservePrice, auction.currentBid, auction.currentBidderId, auction.tags));
                                });
                                resolve(results);
                            }
                            catch (error) {
